...
im_dir = '/data1/yangfan/CenterNetExp/multi_pose_3d/seq3_res18_0804/val/epoch300/'
# output video path
video_dir = './seqvideos/'
...
# splice video_dir
video_dir = os.path.join(video_dir, seq_name+'_seq3_0804_3' + '.avi')
