...
# 验证 or 推断且保存结果到json文件
python test.py multi_pose --exp_id dla_3x --dataset coco_hp --keep_res --load_model ../exp/multi_pose/dla_3x/model_last.pth --split test2 --vis_thresh 0.3 --debug 1
python test.py multi_pose --exp_id dla_3x --dataset coco_hp --keep_res --load_model ../exp/multi_pose/dla_3x/model_last.pth --split val --vis_thresh 0.3 --debug 2
# test.py debug <= 1就不evaluate
# 推断
...
# 验证
python test_3d_val.py multi_pose_3d --exp_id dla_3x_3d_0522_1231_fixCenterNet_RefineEasy_repairGT_l1loss_limit10_val --dataset coco_hp --keep_res --load_model ../exp/multi_pose/dla_3x/model_last.pth --refine_model_dir "/data1/yangfan/CenterNetExp/multi_pose_3d/dla_3x_3d_0522_1231_fixCenterNet_RefineEasy_repairGT_l1loss_limit10/model_Refine3d_38_4.651825075710478.pth" --split val --vis_thresh 0.3 --debug 2 --K 20 --refine_loss l1 --match_max_center_dis 10.0 --object_threshold 0.3 --gpus 4
# 推断
